...
public class ReportService {
    ...
    private Map<Method, String> buildParameterMap(String url) {
    ...
    public List<CriminalReport> loadAllReportsFilteringURL(String url) throws FileNotFoundException {
        return reportRepository.loadAllReportsFiltering(buildParameterMap(url), true);
    }
    ...
    public List<CriminalReport> loadAllPointsFilteringURL(String url) throws FileNotFoundException {
        return reportRepository.loadAllPointsFiltering(buildParameterMap(url));
    }
